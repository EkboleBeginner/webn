...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-121211788-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-121211788-1');
  </script>
</head>
...
s.src = 'https://web1-xz8top85m1.disqus.com/embed.js';
...
s1.async=true;
s1.src='https://embed.tawk.to/5b0d57a010b99c7b36d46bdc/default';
s1.charset='UTF-8';
